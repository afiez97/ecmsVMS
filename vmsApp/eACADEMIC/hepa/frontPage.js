$(function () {
    ...
    async function main() {
        ...
        if (obj.success) {
            let data = obj.data;
            // console.log(data)
            data.employee.ic_passport = data.employee.ic_passport.replace(/-/g, '');
            
            let sad_user = {
                usr_id: data.employee.staff_id,
                usr_icno: data.employee.ic_passport,
                usr_passwd: 'ee578b48ebc5600f1ffdfa3f2e65e473d6af057b510d57d6a3d2f18b2638d458', //nie password default dri boss
                // usr_passwd: 'd502a7ed92abc19912c12c1f77715523718674973a2b8bb8ca11cd420639aba1', //nie password default ikut SSO pnya password
                usr_name: data.name,
                usr_email: null,
                usr_cat_eadmin: 0,
                usr_cat_ehrms: 1,
