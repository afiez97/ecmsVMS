$(function(){
  ...
  if(token == null){
    ...
    doc.text('PROGRAM                        : '+program.toUpperCase(), 14, 55);
      ...
      let obj = new post(host + 'api_pengurusan_pelajar/public/misStdSlipExam/listBySession', form, 'picoms ' + window.sessionStorage.token).execute();
...
if (item.barr_status != null && item.barr_status != "") {
 Duduk  = 'Barred';

} else {
 Duduk  = item.est_tableno;
